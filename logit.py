...
#print(classification_report(test_y, lr2.predict(x_test)))

#accuracy_test2 = model_test(x_test, test_y, lr2)
...
print(binary_classification_performance(test_y, lr2.predict(x_test)))
